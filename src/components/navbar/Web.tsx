    ...
    return (
        <View style={styles.container}>
            <View style={styles.navbar}>
                ...
                <Text ref={cauzaRef} style={[styles.navbarItem, {backgroundColor: isCauzaHovered ? "rgba(180,180,180,0.75)" : "transparent"}]} onPress={() => navigation.navigate('Home')}>Cauze</Text>
